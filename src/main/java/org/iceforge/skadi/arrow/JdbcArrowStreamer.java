...
public final class JdbcArrowStreamer {
    ...
    private static ArrowType toArrowType(int jdbcType, int precision, int scale) {
        return switch (jdbcType) {
            ...
            case Types.FLOAT, Types.REAL -> new ArrowType.FloatingPoint(ArrowType.FloatingPointPrecision.SINGLE);
            case Types.DOUBLE -> new ArrowType.FloatingPoint(ArrowType.FloatingPointPrecision.DOUBLE);
